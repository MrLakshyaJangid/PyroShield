...
const API_VEHICLES = `${import.meta.env.VITE_URL}/api/vehicles`;
const API_MODELS = `${import.meta.env.VITE_URL}/api/vehicles/models`;
const API_STATIONS = `${import.meta.env.VITE_URL}/api/fire-stations/dropdown`;
